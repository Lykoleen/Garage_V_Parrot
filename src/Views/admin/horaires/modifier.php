...
<h1>Modifier les horaires d'ouvertures</h1>

<?php echo $form ?>

<h2 class="mt-2">Consignes d'utilisation</h2>

<div class="journee_avec_pause my-3">
    <p>Pour une ouverture toute la journée avec une pause le midi. Séléctionner un horaire pour les 4 tranches par jour proposés, exemple ci-dessous:</p>
    <img class="img_horaires" src="/assets/img/journee_complete.jpg" >
</div>
